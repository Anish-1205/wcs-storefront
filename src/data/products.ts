...
const SEEDS: ProductSeed[] = [
  {
    ...
    videos: [video("purple-tanchoi-silk", "video-1.mp4", "01-full.jpg", "The purple paisley saree shown in motion")],
    featured: true,
  ...
  },
  {
    ...
    videos: [video("coral-tissue-paithani-pallu", "video-1.mp4", "01-full.jpg", "The coral saree shown in motion")],
    featured: true,
  ...
  },
  {
    ...
    videos: [video("antique-gold-patola-tissue", "video-1.mp4", "01-full.jpg", "The antique-gold saree shown in motion")],
    featured: false,
  ...
  },
  {
    ...
    videos: [video("bandhani-patola-indigo", "video-1.mp4", "01-full.jpg", "The indigo saree shown in motion")],
    featured: true,
    colourRangeNote: null,
  ...
  },
  {
    ...
    videos: [video("bandhani-patola-vermilion", "video-1.mp4", "01-full.jpg", "The vermilion saree shown in motion")],
    featured: false,
    colourRangeNote: null,
    createdAt: "2026-09-04",
  },
  {
    ...
    videos: [video("bandhani-patola-emerald", "video-1.mp4", "01-full.jpg", "The emerald saree shown in motion")],
    featured: false,
    colourRangeNote: null,
    createdAt: "2026-09-04",
  },
  {
    ...
    videos: [video("bandhani-patola-parrot", "video-1.mp4", "01-full.jpg", "The parrot-green saree shown in motion")],
    featured: false,
    colourRangeNote: null,
    createdAt: "2026-09-04",
  },
  ...
  },
  {
    ...
    videos: [
      video("indigo-blockprint-modal-silk", "video-1.mp4", "03-drape.jpg", "The indigo saree drape shown in motion"),
    ],
    featured: true,
