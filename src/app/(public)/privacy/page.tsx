...
export default function PrivacyPage() {
  return (
    <ContentRegion region="page"><article className="container-px mx-auto max-w-3xl py-14">
      ...
      <p className="mt-2 text-base text-muted-foreground">Last updated: 3 September 2026</p>
      <div className="mt-8 space-y-7 leading-relaxed text-foreground/80">
        ...
        <section><h2 className="text-xl text-burgundy">How we use it</h2><p className="mt-2">We use this information to answer enquiries, confirm product availability, assist resellers, send WhatsApp updates you requested, improve the website and protect it from abuse.</p></section>
